...
class MostrarDireccionesAdapter (
    val context: Context,
    val layoutResource: Int,
    var jsonArrayObjetos: JSONArray,
    var listener : OnItemClickListener

) : RecyclerView.Adapter<MostrarDireccionesAdapter.DireccionVH>() {
    ...
    inner class DireccionVH(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(jsonObjeto: JSONObject) {
            ...
            val btnSeleccionar = itemView.findViewById<Button>(R.id.btnSeleccionar)
